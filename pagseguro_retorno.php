	...
	/*
		InstalaÃ§Ã£o
			- Configurando Pagseguro (Acessar https://pagseguro.uol.com.br/preferencias/integracoes.jhtml)
				- NotificaÃ§Ã£o de TransaÃ§Ã£o:
					- http://you-site/pagseguro_ipn.php
				- PÃ¡gina de redirecionamento:
					- A. PÃ¡gina fixa de redirecionamento
						- http://you-site/znote/pagseguro_retorno.php
					- B. Redirecionamento com o cÃ³digo da transaÃ§Ã£o
						- transaction
				- Gerar o Token e copiar para a prÃ³xima etapa
			- Configurando ZnoteACC
				- config.php
					- $config['pagseguro']['email']
						- Seu email da conta do pagseguro que irÃ¡ receber o pagamento
